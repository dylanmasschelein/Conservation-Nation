...
const AreaMap = (props) => {
  ...
  const getINaturalistData = () => {
    ...
    axios
      .get(
        `https://api.inaturalist.org/v1/observations?geo=true&mappable=true&photos=true&nelat=${neLat}&nelng=${neLng}&swlat=${swLat}&swlng=${swLng}&per_page=5`
      )
      .then((observations) => {
        // setObservations;
        ...
        //   coordinates,
        // });
        // setObservation([coordinates[1], coordinates[0]]);
      });
  };
